  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl w-full mt-6 ml-6">
          {/* Swiper Cards */}
          ...
          <div className="bg-white/10 backdrop-blur-lg p-6 rounded-2xl shadow-xl border border-white/20">
            ...
            <p className="text-gray-300 leading-relaxed">
              I’m a passionate full-stack developer focused on building elegant
              and performant web experiences. I enjoy working with modern
              technologies like React, TypeScript, and Node.js to solve
              real-world problems.
            </p>
          </div>
        </div>
